...
const queries = {
  getConsultorios: `SELECT * FROM dbo.consultorio_CENTRO WHERE centro_medico = @centroVal`,
  insertConsultorio: `INSERT INTO dbo.consultorio_CENTRO (id_consultorio, numero, ubicacion, centro_medico) OUTPUT INSERTED.* VALUES (@id_consultorio, @numero, @ubicacion, @centro_medico)`,
};
