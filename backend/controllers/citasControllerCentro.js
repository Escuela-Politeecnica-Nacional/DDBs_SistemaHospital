...
const queries = {
  getCitas: `SELECT id_cita, id_consultorio, id_paciente, fecha, motivo, centro_medico FROM dbo.cita_CENTRO WHERE centro_medico = @centroVal`,
  insertCita: `INSERT INTO dbo.cita_CENTRO (id_cita, id_consultorio, id_paciente, fecha, motivo, centro_medico) OUTPUT INSERTED.* VALUES (@id_cita, @id_consultorio, @id_paciente, @fecha, @motivo, @centro_medico)`,
  deleteCita: `DELETE FROM dbo.cita_CENTRO WHERE id_cita = @id_cita`,
};
