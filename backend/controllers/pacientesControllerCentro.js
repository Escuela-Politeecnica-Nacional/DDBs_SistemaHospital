...
const queries = {
  ...
  getPacienteById: `
    ...
    FROM dbo.paciente_detalle_CENTRO pd
  ...
  insertPacienteDetalle: `
    INSERT INTO dbo.paciente_detalle_CENTRO (id_paciente, nombre, apellido, fecha_nacimiento, genero, centro_medico)
