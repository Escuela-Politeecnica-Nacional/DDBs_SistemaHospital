...
const queries = {
  getHistorial: `SELECT * FROM dbo.historialmedico_CENTRO WHERE centro_medico = @centroVal`,
  insertHistorial: `INSERT INTO dbo.historialmedico_CENTRO (id_cita, observaciones, diagnostico, tratamiento, fecha_registro, centro_medico) OUTPUT INSERTED.* VALUES (@id_cita, @observaciones, @diagnostico, @tratamiento, @fecha_registro, @centroVal)`,
};
