...
const queries = {
  getDoctores: `SELECT * FROM dbo.doctor_CENTRO WHERE centro_medico = @centroVal`,
  insertDoctor: `INSERT INTO dbo.doctor_CENTRO (id_doctor, nombre, apellido, id_especialidad, centro_medico) OUTPUT INSERTED.* VALUES (@id_doctor, @nombre, @apellido, @id_especialidad, @centro_medico)`,
};
