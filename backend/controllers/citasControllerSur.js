...
const queries = {
  getCitas: `SELECT id_cita, id_consultorio, id_paciente, fecha, motivo, centro_medico FROM dbo.cita WHERE centro_medico = @centroVal`,
  insertCita: `INSERT INTO dbo.cita (id_cita, id_consultorio, id_paciente, fecha, motivo, centro_medico) OUTPUT INSERTED.* VALUES (@id_cita, @id_consultorio, @id_paciente, @fecha, @motivo, @centro_medico)`,
  deleteCita: `DELETE FROM dbo.cita WHERE id_cita = @id_cita`,
};
